...
\begin{section}{Academic Experience}
    ...
    %     \item Utilize OpenAI API to implement conversation-based chatbot in a React app for PHQ-9 depression screening
    %     \item Conduct UX and UI research investigating the effects of culturally tailoring the chatbot's design for marginalized populations in order to enhance patient outcomes
    % \end{subsection}
\end{section}
