...
\begin{section}{Education}
    \sep{4pt}
    \horibar{\textbf{University of Virginia, College of Arts and Sciences}}{Charlottesville, VA} \hfill Aug 2022–Dec 2026
    \sep{4pt}
...
\begin{section}{Academic Experience}
    ...
    \end{subsection}
    \begin{subsection}{Head Teaching Assistant}{\horibar{University of Virginia, Computer Science}{Charlottesville, VA}}{Mar 2024–Dec 2025}
    ...
    \begin{subsection}{Teaching Assistant}{\horibar{University of Virginia, Computer Science}{Charlottesville, VA}}{Aug 2024–May 2025}
        \item Enhanced students’ learning in Computer Systems and Organization II, and Discrete Mathematics, through 3 weekly hours of class, office hours and lab, guiding to individual understanding
        \item Crafted and reviewed exam questions synthesizing multiple topics to test limits of students’ knowledge
    \end{subsection}
    % \begin{subsection}{Lead Research Assistant}{\horibar{University of Virginia, Marcus Project}{Charlottesville, VA}}{September 2023–May 2024}
    %     \item Utilized OpenAI API to implement conversation-based chatbot in a React app for PHQ-9 depression screening
    %     \item Conducted UX and UI research investigating the effects of culturally tailoring the chatbot's design for marginalized populations in order to enhance patient outcomes
    % \end{subsection}
\end{section}

\begin{section}{Technical Projects and Skills}
    \begin{subsection}{sattle}{Technologies: Rust, C, LLVM}{Aug 2026–Present}
        \item Crafting a domain-specific language for implementing conflict-driven clause learning SAT solvers
        \item Implementing SAT-specific optimisations including arena allocators, bit-level layouts and universe-bound dense maps
        \item Exploring potential of LLMs targeting DSLs in code generation of SAT solvers designed for individual formulas
    \end{subsection}
    \begin{subsection}{Multicore Operating System}{Technologies: C, ARM64 Assembly, QEMU, Raspberry Pi}{Jan 2025–May 2025}
        \item Built from bare-metal to a rich, multicore OS supporting concurrent applications and a filesystem
        \item Executed on hardware with support for I/O devices including keyboard input, video display, and sound output
    \end{subsection}
    ...
    \textbf{Programming Skills:} C\#/.NET, Rust, C++, C, CUDA, Python, SQL/Microsoft SQL Server, Java, x86 \& ARM64 Assembly, Bash/Unix, LLVM, JavaScript, HTML/CSS, Git and GitHub, R, VBA, Lua, Julia
    \par\setstretch{0}
    \sep{2pt}
    }
\end{section}
