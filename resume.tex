...
\begin{section}{Education}
    \sep{4pt}
    \horibar{\textbf{University of Virginia, College of Arts and Sciences}}{Charlottesville, VA} \hfill Aug 2022–December 2026
    \sep{4pt}
...
\begin{section}{Technical Projects and Skills}
    ...
    \textbf{Programming Skills:} C\#/.NET, C++, C, CUDA, SQL/Microsoft SQL Server, Java, Python, x86 \& ARM64 Assembly, Bash/Unix, LLVM, JavaScript, HTML/CSS, Git and GitHub, R, VBA, Lua, Julia
    \par\setstretch{0}
    \sep{2pt}
    }
\end{section}
